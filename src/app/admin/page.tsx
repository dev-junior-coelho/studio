    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><ArrowRight className="h-5 w-5 rotate-[-45deg]" /> Acompanhamento de Vendas</CardTitle>
                        <CardDescription>Visualize todas as vendas realizadas por sua equipe.</CardDescription>
                    </CardHeader>
                    <CardContent>
