...
const produtosParaCadastrar = [
  ...
  ...['padrao', 'especial'].flatMap(regiao => [
    {
      regiaoId: regiao, tipo: "TV Cabeada", nome: "CTV+ TOP HD 4K SOUND MULTI", precoMensal: 154.90, precoAnual: null, ordem: 30,
    ...
    {
      regiaoId: regiao, tipo: "TV Cabeada", nome: "CTV+ TOP HD 4K SOUND", precoMensal: 164.90, precoAnual: null, ordem: 31,
    ...
    {
      regiaoId: regiao, tipo: "TV Cabeada", nome: "CTV+ TOP HD 4K MULTI", precoMensal: 124.90, precoAnual: null, ordem: 32,
    ...
    {
      regiaoId: regiao, tipo: "TV Cabeada", nome: "CTV+ TOP HD 4K", precoMensal: 134.90, precoAnual: null, ordem: 33,
  ...
  {
    regiaoId: "fibra-pura", tipo: "TV Box", nome: "CLARO STREAMING HD TOP SOUND MULTI", precoMensal: 154.90, precoAnual: null, ordem: 40,
    beneficios: [...beneficiosTVComboCompleto, "Equipamento: Soundbox (Áudio Dolby Atmos)", "Benefício Multi: ChatGPT Plus (se Multi)"],
    observacoes: "Pacote Soundbox Streaming. Preço COM BL E MÓVEL (p.66). Desconto de R$ 5,00 no DCC+Fatura Digital."
  },
  {
    regiaoId: "fibra-pura", tipo: "TV Box", nome: "CLARO STREAMING HD TOP MULTI", precoMensal: 124.90, precoAnual: null, ordem: 41,
  ...
  {
    regiaoId: "fibra-pura", tipo: "TV Box", nome: "CLARO STREAMING HD TOP", precoMensal: 134.90, precoAnual: null, ordem: 42,
  ...
  ...['med-01', 'med-02', 'med-03', 'especial-promo-6m', 'especial-promo-3m', 'especial-plus', 'especial-plus-promo-6m', 'especial-plus-promo-3-6m', 'especial-plus-promo-3m', 'especial-plus-promo-3m-b', 'med-redes-neutras-02'].flatMap(regiao => [
    ...
    {
      regiaoId: regiao, tipo: "TV Box", nome: "CLARO STREAMING HD TOP SOUND MULTI", precoMensal: 154.90, precoAnual: null, ordem: 40,
      beneficios: [...beneficiosTVComboCompleto, "Equipamento: Soundbox (Áudio Dolby Atmos)", "Benefício Multi: ChatGPT Plus (se Multi)"],
    ...
    {
      regiaoId: regiao, tipo: "TV Box", nome: "CLARO STREAMING HD TOP MULTI", precoMensal: 104.90, precoAnual: null, ordem: 41,
      beneficios: [...beneficiosTVComboCompleto, "Equipamento: Box Streaming", "Benefício Multi: ChatGPT Plus (se Multi)"],
      observacoes: "Pacote Box Streaming. Preço MED (p.67). Desconto R$ 5,00 DCC."
    },
    {
      regiaoId: regiao, tipo: "TV Box", nome: "CLARO STREAMING HD TOP", precoMensal: 134.90, precoAnual: null, ordem: 42,
      beneficios: [...beneficiosTVComboCompleto, "Equipamento: Box Streaming"],
      observacoes: "Pacote Box Streaming. Preço MED (p.67). Desconto R$ 5,00 DCC."
    }
  ]),
  ...
  {
    regiaoId: "nacional", tipo: "TV Box", nome: "CLARO TV BOX ANUNCIO (Não Cabeada) MULTI", precoMensal: 124.90, precoAnual: null, ordem: 44,
    beneficios: [...beneficiosTVComboCompleto, "Equipamento: Box Streaming", "Benefício Multi: ChatGPT Plus (se Multi)"],
    observacoes: "Preço para ÁREA NÃO CABEADA COM MÓVEL (p.68). Desconto R$ 5,00 DCC."
  },
  {
    regiaoId: "nacional", tipo: "TV Box", nome: "CLARO TV BOX ANUNCIO (Não Cabeada) SINGLE", precoMensal: 134.90, precoAnual: null, ordem: 44,
    beneficios: [...beneficiosTVComboCompleto, "Equipamento: Box Streaming"],
  ...
  {
    regiaoId: "nacional", tipo: "Claro TV APP", nome: "CLARO TV+ APP ANUAL", precoMensal: 99.90, precoAnual: 1198.90, ordem: 50,
  ...
  {
    regiaoId: "nacional", tipo: "Claro TV APP", nome: "CLARO TV+ APP MENSAL", precoMensal: 109.90, precoAnual: null, ordem: 51,
    beneficios: ["Mais de 120 canais ao vivo", "Netflix (Padrão com Anúncios)", "HBO Max (Básico com Anúncios)", "Apple TV+", "Disney+ (Padrão com Anúncios)", "Amazon Prime Video", "Amazon Music, Prime Gaming, Prime Reading e Frete Grátis", "Acesso por App (sem equipamento)", "Contratação 100% Digital (Cartão de Crédito)"],
    observacoes: "Preço promocional R$ 65,40 por 2 meses. Não possui benefícios Multi."
  },
  {
    regiaoId: "nacional", tipo: "Claro TV APP", nome: "CLARO TV+ STREAMINGS ANUAL", precoMensal: 69.90, precoAnual: 838.80, ordem: 52,
  ...
  {
    regiaoId: "nacional", tipo: "Claro TV APP", nome: "CLARO TV+ STREAMINGS MENSAL", precoMensal: 79.90, precoAnual: null, ordem: 53,
    beneficios: ["NÃO inclui canais ao vivo", "Netflix (Padrão com Anúncios)", "HBO Max (Básico com Anúncios)", "Apple TV+", "Disney+ (Padrão com Anúncios)", "Amazon Prime Video", "Amazon Music, Prime Gaming, Prime Reading e Frete Grátis", "Acesso por App (sem equipamento)", "Contratação 100% Digital (Cartão de Crédito)"],
  ...
  {
    regiaoId: "nacional", tipo: "TV Cabeada", nome: "INICIAL HD RET ANUNCIO FID", precoMensal: 69.90, precoAnual: null, ordem: 10,
  ...
  {
    regiaoId: "nacional", tipo: "TV Cabeada", nome: "INICIAL HD RET ANUNCIO TELECINE FID", precoMensal: 79.90, precoAnual: null, ordem: 11,
    beneficios: ["Pacote Inicial HD", "Acesso aos canais Telecine", "Globoplay Canais Incluso"],
    observacoes: "Preço de UPGRADE (p.71). SEM Disney/Amazon. Desconto R$ 5,00 DCC. Fidelidade 12m."
  },
  {
    regiaoId: "nacional", tipo: "TV Cabeada", nome: "CTV+ TOP HD RET ANUNCIO FID", precoMensal: 104.90, precoAnual: null, ordem: 20,
    beneficios: [...beneficiosTVComboUpgrade, "Equipamento: Decodificador HD"],
    observacoes: "Preço de UPGRADE (p.71). SEM Disney/Amazon. Desconto R$ 5,00 DCC. Fidelidade 12m."
  },
  {
    regiaoId: "nacional", tipo: "TV Box", nome: "CLARO STREAMING HD TOP RENT ANUNCIO FID", precoMensal: 104.90, precoAnual: null, ordem: 43,
    beneficios: [...beneficiosTVComboUpgrade, "Equipamento: Box Streaming"],
    observacoes: "Preço de UPGRADE (p.71). SEM Disney/Amazon. Desconto R$ 5,00 DCC. Fidelidade 12m."
  },
  {
    regiaoId: "nacional", tipo: "TV Cabeada", nome: "CTV+TOP HD 4K RENT ANUNCIO FID", precoMensal: 144.90, precoAnual: null, ordem: 34,
    beneficios: [...beneficiosTVComboUpgrade, "Equipamento: Box Cabo (Qualidade 4K)"],
    observacoes: "Preço de UPGRADE (p.71). SEM Disney/Amazon. Desconto R$ 5,00 DCC. Fidelidade 12m."
  },
  {
    regiaoId: "nacional", tipo: "TV Cabeada", nome: "CLARO TV+ SOUNDBOX RENT ANUNCIO FID", precoMensal: 154.90, precoAnual: null, ordem: 35,
  ...
  { regiaoId: "nacional", tipo: "Ponto Adicional", nome: "Ponto Adicional - HD (Upgrade TOP HD R$ 10,00)", precoMensal: 10.00, precoAnual: null, beneficios: ["Aluguel de 1 equipamento HD adicional"], observacoes: "Valor de aluguel mensal. Para plano Upgrade TOP HD (p.71)." },
